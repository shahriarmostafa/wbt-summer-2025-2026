...
<body>
  ...
  <form class="card" method="post" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" novalidate>
    ...
    <div class="field">
        <input type="checkbox" name="email-me" id="">
        <label for="email-me">Email me with the product updates</label> <br>
        <input type="checkbox"  name="email-me" id="">
        <label for="privacy">Accept the privacy and policy</label>
    </div>
